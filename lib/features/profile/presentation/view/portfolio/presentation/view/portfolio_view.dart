...
import 'package:jobsque/features/profile/presentation/view/portfolio/presentation/view/widgets/portfolio_body_bloc_consumer.dart';
...
class _PortfolioViewState extends State<PortfolioView> {
  ...
  Widget build(BuildContext context) {
    return const Scaffold(
      body: SafeArea(
        child: PortfolioBodyBlocConsumer(),
      ),
    );
  }
}
